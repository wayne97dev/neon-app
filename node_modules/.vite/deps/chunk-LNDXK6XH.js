...
var ICONS = {
  add: async () => (await import("./add-7Z2UA4HU.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-URTNO74I.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-MV7N22XN.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-KM5JTAKP.js")).appStoreSvg,
  apple: async () => (await import("./apple-DZMOBRYY.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-YQRDVDV5.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-JKGN2LVH.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-HPJKJKF5.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-ZW6THXL6.js")).arrowTopSvg,
  bank: async () => (await import("./bank-PW6B4BK4.js")).bankSvg,
  browser: async () => (await import("./browser-LMEPSGWE.js")).browserSvg,
  card: async () => (await import("./card-4VSATA3M.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-ZF6MPCOR.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-G4BN7OH5.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-XMBQK7MX.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-BG62TNDU.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-F4RYRSCG.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-FJWG6PCM.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-WBK7KOSQ.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-7X27JOUC.js")).clockSvg,
  close: async () => (await import("./close-IOX5FJWA.js")).closeSvg,
  compass: async () => (await import("./compass-2KVDFXKC.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-F7ZZHXJ3.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-BMXD4A26.js")).copySvg,
  cursor: async () => (await import("./cursor-E6CJLNBZ.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-JAG6YLXG.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-HW35GK46.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-2SHB4GG4.js")).disconnectSvg,
  discord: async () => (await import("./discord-5KPHKY3J.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-DVNV3HJ5.js")).etherscanSvg,
  extension: async () => (await import("./extension-PZJVSGGC.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-Y4MB75NQ.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-OR4JCA44.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-Q7CTEFJW.js")).farcasterSvg,
  filters: async () => (await import("./filters-O5LTRIN2.js")).filtersSvg,
  github: async () => (await import("./github-LDRO4M6Y.js")).githubSvg,
  google: async () => (await import("./google-2BGXLBMX.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-VVPCAPYU.js")).helpCircleSvg,
  image: async () => (await import("./image-R4MGYRTO.js")).imageSvg,
  id: async () => (await import("./id-3MNMKYBF.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-DSOMW2SS.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-JOTVYLFZ.js")).lightbulbSvg,
  mail: async () => (await import("./mail-5OXBRKM7.js")).mailSvg,
  mobile: async () => (await import("./mobile-72QT6AMI.js")).mobileSvg,
  more: async () => (await import("./more-AT73ZSY6.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-OKQAFH67.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-FD6H72VI.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-4KJWFNVS.js")).offSvg,
  playStore: async () => (await import("./play-store-XCRIUJZF.js")).playStoreSvg,
  plus: async () => (await import("./plus-ITZ63WGI.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-LEF47I6U.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-RD2GUEOE.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-M56UNZ5R.js")).refreshSvg,
  search: async () => (await import("./search-OSNNMJCP.js")).searchSvg,
  send: async () => (await import("./send-I43RV34K.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-VUIDFYHY.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-OBCYMT6X.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-JKDS63IW.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-76QEW5MX.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-HYGVDQOI.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-BBA2D6NN.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-3MTN4CBW.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-EK6NB7HS.js")).twitchSvg,
  twitter: async () => (await import("./x-QR5PYRAZ.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-H2LQYWDM.js")).twitterIconSvg,
  verify: async () => (await import("./verify-3CO5JWGY.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-EQOERSU7.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-3TR7VQDF.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-J34MYISM.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-J34MYISM.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-J34MYISM.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-WYLD3WZ7.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-PHLNQXFX.js")).warningCircleSvg,
  x: async () => (await import("./x-QR5PYRAZ.js")).xSvg,
  info: async () => (await import("./info-3QXVWDH3.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-RHBZK2JX.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-3ZKJL2AA.js")).reownSvg
};
...
lit-html/development/directive-helpers.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-LNDXK6XH.js.map
